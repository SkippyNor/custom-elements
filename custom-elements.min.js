...
HTMLElement:window.HTMLElement,HTMLElement_innerHTML:Object.getOwnPropertyDescriptor(window.HTMLElement.prototype,"innerHTML"),HTMLElement_insertAdjacentElement:window.HTMLElement.prototype.insertAdjacentElement};A.default=C;var D={default:function(b){window.HTMLElement=function(){function a(){var a=this.constructor,c=b.constructorToDefinition(a);if(!c)throw Error("The custom element being constructed was not registered with `customElements`.");var e=c.constructionStack;if(0===e.length)return e=A.default.Document_createElement.call(document,c.localName),Object.setPrototypeOf(e,a.prototype),e.__CE_state=m.default.custom,e.__CE_definition=c,b.patch(e),e;var c=e.length-1,d=e[c];if(d===g.default)throw Error("The HTMLElement constructor was either called reentrantly for this constructor or called multiple times.");
e[c]=g.default;Object.setPrototypeOf(d,a.prototype);b.patch(d);return d}a.prototype=A.default.HTMLElement.prototype;return a}()}};var E={default:function(b,a,f){a.prepend=function(a){for(var e=[],d=0;d<arguments.length;++d)e[d-0]=arguments[d];d=e.filter(function(b){return b instanceof Node&&k.isConnected(b)});f.prepend.apply(this,e);for(var c=0;c<d.length;c++)b.disconnectTree(d[c]);if(k.isConnected(this))for(d=0;d<e.length;d++)c=e[d],c instanceof Element&&b.connectTree(c)};a.append=function(a){for(var e=[],d=0;d<arguments.length;++d)e[d-0]=arguments[d];d=e.filter(function(b){return b instanceof Node&&k.isConnected(b)});f.append.apply(this,
