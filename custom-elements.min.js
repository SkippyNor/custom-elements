...
return d},P=a.prototype;if(!(P instanceof Object))throw new TypeError("The custom element constructor's prototype is not an object.");c=p("connectedCallback");d=p("disconnectedCallback");f=p("adoptedCallback");g=p("attributeChangedCallback");u=a.observedAttributes||[]}catch(va){return}finally{this.h=!1}this.j.push({localName:b,constructor:a,connectedCallback:c,disconnectedCallback:d,adoptedCallback:f,attributeChangedCallback:g,observedAttributes:u,constructionStack:[]});this.g||(this.g=!0,this.i(function(){return da(e)}))};
function da(b){if(!1!==b.g){b.g=!1;for(var a=b.j,e=new Map,c=0;c<a.length;c++)e.set(a[c].localName,[]);for(A(b.c,document,{s:function(d){y(b.c,d);if(void 0===d.__CE_state){var a=e.get(d.localName);a&&a.push(d)}}});0<a.length;){var d=a.shift(),c=d.localName;ba(b.c,c,d);for(var d=e.get(d.localName),f=0;f<d.length;f++)y(b.c,d[f]);(c=b.l.get(c))&&D(c)}}}E.prototype.get=function(b){if(b=this.c.a.get(b))return b.constructor};
...
oa=window.a,W=Object.getOwnPropertyDescriptor(window.a.prototype,"innerHTML"),X=window.a.prototype.insertAdjacentElement;function pa(){var b=Y;window.XULElement=function(){function a(){var a=this.constructor,c=b.m.get(a);if(!c)throw Error("The custom element being constructed was not registered with `customElements`.");var d=c.constructionStack;if(!d.length)return d=F.call(document,c.localName),Object.setPrototypeOf(d,a.prototype),d.__CE_state=1,d.__CE_definition=c,w(b,d),d;var c=d.length-1,f=d[c];if(f===h)throw Error("The XULElement constructor was either called reentrantly for this constructor or called multiple times.");
...
return a})}M?q(Element.prototype,"attachShadow",function(a){return this.__CE_shadowRoot=a=M.call(this,a)}):console.warn("Custom Elements: `Element#attachShadow` was not patched.");if(N&&N.get)a(Element.prototype,N);else if(W&&W.get)a(XULElement.prototype,W);else{var c=F.call(document,"div");t(b,function(b){a(b,{enumerable:!0,configurable:!0,get:function(){return G.call(this,!0).innerHTML},set:function(a){var b="template"===this.localName?this.content:this;for(c.innerHTML=a;0<b.childNodes.length;)J.call(b,
